...
void test4() {
    std::vector<int> sequence;
    create_lis_of_size( 7000, 50000, sequence );
    std::vector<unsigned> answer = longest_increasing_subsequence( sequence );
    std::cout << "Subsequence size " << answer.size() << std::endl;
    print_subsequence( answer, sequence );
}
...
void customTest() {
    ...
    std::vector<int> sequence;
    sequence.push_back(10);    sequence.push_back(22);    sequence.push_back(9);
    sequence.push_back(33);    sequence.push_back(21);    sequence.push_back(50);
    sequence.push_back(41);    sequence.push_back(60);
